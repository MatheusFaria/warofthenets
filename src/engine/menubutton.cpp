...
MenuButton::MenuButton(int _x, int _y, int _width, int _height, string _imageId, void (*_callback)())
: SDLGameObject(_x, _y, _width, _height, _imageId), callback(_callback)
{
